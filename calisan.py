...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 26 12:34:30 2021
...
train_path = '/home/ozlem/Downloads/tomato_data/train'

valid_path = '/home/ozlem/Downloads/tomato_data/valid'
...
class myNet(nn.Module):      #LeNet, Common net
    ...
    def forward(self, input):
        x = F.max_pool2d(F.relu((self.bn1(self.conv1(input)))), 4)    
...
def train(model,train_loader,test_loader,epochs,optimizer):
    ...
    plt.suptitle('Leaves extracted + downsampled x4')
...
for filename in  os.listdir(test_path):
    ...
    plt.imshow(img)
    guess = Train.classes[prediction]
